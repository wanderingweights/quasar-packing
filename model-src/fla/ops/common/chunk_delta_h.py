...
def chunk_gated_delta_rule_bwd_dhu(
    ...
    chunk_gated_delta_rule_bwd_kernel_dhu_blockdim64[grid](
        ...
        V=V,
        BT=BT,
        BV=64 if check_shared_mem('ada', q.device.index) else 32,
        USE_EXP2=use_exp2,
        TRANSPOSE_STATE=transpose_state_layout,
        # H200 autotune spends a long time walking this backward state kernel
        # across both ranks. Use a deterministic fixed launch.
        num_warps=4,
        num_stages=2,
    )
    return dh, dh0, dv2
