...
def recompute_w_u_fwd_quasar_kernel(
    q,
    k,
    qg,
    kg,
    ...
    for i_v in range(tl.cdiv(V, BV)):
        ...
        b_u = tl.dot(b_A.to(b_vb.dtype), b_vb)
    ...
    for i_k in range(tl.cdiv(K, BK)):
        ...
        b_w = tl.dot(b_A.to(b_k.dtype), b_kb.to(b_k.dtype))
...
@triton.jit(do_not_specialize=['T'])
def prepare_wy_repr_bwd_quasar_kernel(
    k,
    v,
    beta,
    gk,
...
def recompute_w_u_fwd(
    ...
    recompute_w_u_fwd_quasar_kernel[(NT, B*H)](
        q=q,
        k=k,
        qg=qg,
        kg=kg,
...
def prepare_wy_repr_bwd(
    ...
    prepare_wy_repr_bwd_quasar_kernel[(NT, B * H)](
        k=k,
        v=v,
        beta=beta,
        gk=gk,
