...
from fla.ops.quasar.wy_fast import recompute_w_u_fwd
from fla.ops.quasar.chunk_intra_token_parallel import chunk_quasar_fwd_intra_token_parallel
...
def chunk_quasar_fwd_kernel_inter_solve_fused(
    q,
    k,
    g,
    beta,
...
def chunk_quasar_bwd_kernel_intra(
    q,
    k,
    g,
    beta,
...
@triton.jit(do_not_specialize=['T'])
def chunk_quasar_fwd_kernel_intra_sub_chunk(
    q,
    k,
    g,
    beta,
...
def chunk_quasar_fwd_intra(
    ...
    chunk_indices: tuple[torch.Tensor] | None = None,
    ...
    if safe_gate:
        ...
        chunk_quasar_fwd_kernel_intra_sub_chunk[grid](
            q=q,
            k=k,
            g=gk,
            beta=beta,
        ...
        Aqk, Akkd = chunk_quasar_fwd_intra_token_parallel(
            q=q,
            k=k,
            gk=gk,
            beta=beta,
    ...
    grid = (NT, B * H)
    chunk_quasar_fwd_kernel_inter_solve_fused[grid](
        q=q,
        k=k,
        g=gk,
        beta=beta,
...
def chunk_quasar_bwd_intra(
    ...
    grid = (NK * NC, NT, B * H)
    chunk_quasar_bwd_kernel_intra[grid](
        q=q,
        k=k,
        g=g,
        beta=beta,
